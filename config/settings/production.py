...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["api.mtour.kz"])
# DATABASES
# ------------------------------------------------------------------------------
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="MedTour <noreply@mtour.kz>",
)
EMAIL_HOST = env("SMTP_HOST")
EMAIL_PORT = 465
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True
EMAIL_HOST_USER = 'noreply@mtour.kz'
...
THUMBNAIL_REDIS_DB = env.int("REDIS_DB")
...
SESSION_COOKIE_DOMAIN = ".mtour.kz"
